...
@pytest.fixture
def session():
    Base.metadata.drop_all(bind=engine) # type: ignore #ignore
    Base.metadata.create_all(bind=engine) # type: ignore #ignore
...
def test_user2(client):
    user_data = {"email": "test@example1.com", "password": "password123"}
